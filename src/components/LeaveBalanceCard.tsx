      ...
      <div className="h-full min-h-[230px] rounded-2xl border border-gray-100 bg-white p-6 flex flex-col">
        <div className="grid grid-cols-[minmax(0,1fr)_auto] items-start gap-4">
          <div className="min-w-0">
            ...
            <p className="mt-2 text-xs leading-5 text-gray-400">สิทธิ์ลาป่วยไม่จำกัดจำนวนวัน</p>
          </div>
          <div className="text-right">
            <p className="whitespace-nowrap text-3xl font-bold leading-none text-sky-600">{usedLabel}</p>
            <p className="mt-2 whitespace-nowrap text-xs text-gray-400">ลาไปแล้ว</p>
          </div>
        </div>
        <div className="mt-auto rounded-xl bg-sky-50 px-4 py-3 text-center text-sm font-medium text-sky-700">ไม่จำกัดสิทธิ์</div>
      </div>
    );
  }
